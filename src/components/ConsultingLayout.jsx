...
const ConsultingLayout = ({ data }) => {
  ...
  return (
    <div className="w-full min-h-screen overflow-x-hidden" style={{ background: t.bg }}>
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            itemListElement: [
              ...
              { "@type": "ListItem", position: 2, name: "Consultancy", item: "https://www.webaurix.com/#services" },
      ...
      {/*  HERO  */}
      <section className="relative overflow-hidden pt-36 sm:pt-48 pb-20 sm:pb-28 px-5 sm:px-10 lg:px-16">
        <div
          ...
          <div className="max-w-[820px]">
            ...
            >
              <Link to="/book-consultation" className="flex-1 sm:flex-none">
                ...
                >
                  <Zap size={14} /> Book a Consultation
                </motion.span>
              </Link>
            ...
            >
              {data.stats.map((s, i) => (
                <div key={i}>
                  <p className="text-[22px] sm:text-[26px] font-black leading-none" style={{ color: accent }}>{s.value}</p>
      ...
      <section className="px-5 sm:px-10 lg:px-16 py-14 sm:py-20" style={{ borderTop: `1px solid ${t.Br}` }}>
        <div className="max-w-[1300px] mx-auto">
          ...
          <motion.h2 {...fadeUp(0.06)} className="text-[26px] sm:text-[38px] font-bold leading-[1.12] tracking-tight mb-12 max-w-[600px]" style={{ color: t.P }}>
            A structured path to <span style={{ color: accent }}>measurable results.</span>
          </motion.h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-5">
            {data.process.map((p, i) => (
              ...
              >
                <span className="text-[40px] font-black leading-none block mb-4" style={{ color: `${accent}22` }}>0{i + 1}</span>
      ...
      <section className="px-5 sm:px-10 lg:px-16 py-14 sm:py-20" style={{ borderTop: `1px solid ${t.Br}` }}>
        <div className="max-w-[1300px] mx-auto grid grid-cols-1 lg:grid-cols-[1fr_1fr] gap-8 lg:gap-14">
            ...
            <div className="space-y-3">
              {data.outcomes.map((u, i) => (
                <motion.div
                  ...
                  style={{ background: t.Cd, border: `1px solid ${t.Br}` }}
                >
                  <div className="w-6 h-6 rounded-lg flex items-center justify-center flex-shrink-0 mt-0.5" style={{ background: t.Adim }}>
          ...
          <div>
            ...
            <motion.h2 {...fadeUp(0.06)} className="text-[24px] sm:text-[32px] font-bold leading-[1.12] tracking-tight mb-8" style={{ color: t.P }}>
              Proven methods, <span style={{ color: accent }}>modern tooling.</span>
            </motion.h2>
            ...
            >
              ...
              <p className="text-[13px] font-bold mb-2 relative z-10" style={{ color: accent }}>{data.highlight.title}</p>
              <p className="text-[13.5px] leading-[1.75] relative z-10" style={{ color: t.M }}>{data.highlight.desc}</p>
            </motion.div>
          </div>
        </div>
      </section>
